--- 
description: Create a roadmap and a skill-tree of any desired skill.
...
## Prompt: 
0. As fill up the uninitiated values for the Variables. If any values with defaults are left without input use the defaults and divide the [LEVEL] based on [GOAL] and display what each level denotes.
